...
import com.mycompany.myapp.repository.CapteurRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Capteur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Capteur> partialUpdateCapteur(
        ...
        Optional<Capteur> result = capteurRepository
            ...
            .map(existingCapteur -> {
                ...
                if (capteur.getFrequence() != null) {
                    existingCapteur.setFrequence(capteur.getFrequence());
                }
