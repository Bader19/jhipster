...
public class GrandeurResource {
    ...
    public ResponseEntity<Grandeur> updateGrandeur(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, grandeur.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Grandeur> partialUpdateGrandeur(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, grandeur.getId().toString())
        );
    }
