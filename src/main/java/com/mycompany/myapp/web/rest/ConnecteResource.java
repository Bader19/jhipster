...
import com.mycompany.myapp.repository.ConnecteRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Connecte}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ConnecteResource {
    ...
    public ResponseEntity<Connecte> updateConnecte(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, connecte.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Connecte> partialUpdateConnecte(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, connecte.getId().toString())
        );
    }
