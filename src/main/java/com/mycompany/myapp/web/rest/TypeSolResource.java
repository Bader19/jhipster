...
import com.mycompany.myapp.repository.TypeSolRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.TypeSol}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TypeSolResource {
    ...
    public ResponseEntity<TypeSol> createTypeSol(@RequestBody TypeSol typeSol) throws URISyntaxException {
    ...
    public ResponseEntity<TypeSol> updateTypeSol(@PathVariable(value = "id", required = false) final Long id, @RequestBody TypeSol typeSol)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, typeSol.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeSol> partialUpdateTypeSol(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, typeSol.getId().toString())
        );
    }
